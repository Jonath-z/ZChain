      ...
      <div className="bg-cyan-900 py-3 px-3 rounded-md border border-[#221a0c] flex justify-between xsm:flex-col sm:flex-col">
        <a href={nft.image} target="_blank" rel="noreferrer">
          <img
            src={nft.image}
            alt="nft-image"
            className="rounded-md w-96 object-fill m-auto my-3"
          />
        </a>
        <div className="2xl:px-10 lg:px-10 px-10 flex flex-col justify-between">
          <div className="text-white py-3">
            <p className="font-bold text-xl text-transparent bg-clip-text bg-gradient-to-r from-white to-[#ffa503]">
              {nft.name}
            </p>
            <p className="w-96">{nft.description}</p>
          </div>
          <div>
