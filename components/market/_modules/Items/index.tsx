...
const Items = () => {
  ...
  if (!isloading && !nfts.length) return (
    <div className="bg-black h-screen">
      <Header background='bg-black' activeMenu="explore" onChange={onChange} isSearchAvailabe={true}/>
    ...
    <div className="bg-black">
      ...
      <div className="bg-black h-screen overflow-y-auto">
        <div className="mt-32 px-36 xsm:mt-5 sm:mt-5 xsm:px-5 sm:px-5 lg:px-10 lg:mt-2">
          <h1 className="text-white text-5xl py-10 xsm:py-0 sm:py-0 xsm:text-3xl sm:text-3xl">All NFTs for sale</h1>
